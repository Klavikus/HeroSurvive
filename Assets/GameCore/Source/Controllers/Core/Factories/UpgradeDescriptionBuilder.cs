...
{
    public class UpgradeDescriptionBuilder : IUpgradeDescriptionBuilder
    {
        ...
        public UpgradeDescriptionBuilder(IConfigurationProvider configurationProvider, ILocalizationService translationService)
        {
